...
public class AtmFun {
	public AtmFun() {
		...
		while (attempt != 0) {
			...
			if(n.getFifty()*50 + n.getHundred()*100 >= amount) {
			...
			System.out.println(" Enter the number of 50 notes");
			 i50 = sc.nextInt();
				...
				System.out.println("LIMIT EXCEEDED! Requested amount not available right now");
				System.out.println("Available Amount is" + (n.getFifty()*50 + n.getHundred()*100));
			}
